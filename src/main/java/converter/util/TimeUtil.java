...
public class TimeUtil {
  ...
  public static int minutesInPeriod(String period, int minutes) {
    if (period.equals(H1.getShortForm()) && isAdditionalTime(period, minutes)) return 45;
    else if (period.equals(H2.getShortForm()) && isAdditionalTime(period, minutes)) return 90;
    return 0;
  }
